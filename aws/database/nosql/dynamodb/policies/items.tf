...
resource "aws_dynamodb_table_item" "notification_dlq_default_item" {
    table_name = aws_dynamodb_table.onebank_notification_dlq_table.name
    hash_key = aws_dynamodb_table.onebank_notification_dlq_table.hash_key
    range_key = aws_dynamodb_table.onebank_notification_dlq_table.range_key
