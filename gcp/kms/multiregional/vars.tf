...
variable "LOCATION_ID" {
    type = string
    default = "us"
    description = "MultiRegion where KMS keys will be located"
}
...
variable "CREATE_KMS_KEYRING" {
    default = false
    type = bool
    description = "It specify whether a new keyring should be created"
}

variable "CREATE_KMS_KEY" {
    default = true
    type = bool
    description = "It specify whether a new KMS key should be created"
}