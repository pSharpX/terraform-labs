...
variable "DEFAULT_NETWORK" {
    type = string
    description = "Default network name for firewall rules to be applied"
}

variable "IPV4_RANGES" {
    type = list(string)
    description = "Default network's IP ranges for which firewall rules will be applied"
}
