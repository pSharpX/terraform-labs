...
resource "google_compute_region_instance_group_manager" "onebank_instance_group_1" {
...
resource "google_compute_region_autoscaler" "autoscaling_1" {
    name = "onebank-backend-autoscaler-1"
    target = google_compute_region_instance_group_manager.onebank_instance_group_1.id
    region = data.google_compute_subnetwork.private_1.region
